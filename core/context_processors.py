    ...
    # Menu pour enseignants
        ...
        menu_items = [
            ...
            },
            {
                ...
                'icon': '📋',
                'submenu': [
                    {'title': 'Liste des grilles', 'url': safe_reverse('grilles:liste')},
                    {'title': 'Créer une grille', 'url': safe_reverse('grilles:creer')},
                    {'title': 'Importer depuis Word', 'url': safe_reverse('grilles:import_word')},
                ],
